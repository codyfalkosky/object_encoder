...
class ObjEncoderV2:
    ...
    def __init__(self, omit_structure=[], beta_clips=1, beta_coords=1, beta_combined=1, beta_em=1, dropout_rate=0):
        '''
        Returns Object Encoder model at self.model
        '''
        self.model = self._build_model(omit_structure, beta_clips, beta_coords, beta_combined, beta_em, dropout_rate)

    def _build_model(self, omit_structure, beta_clips, beta_coords, beta_combined, beta_em, dropout_rate):
        '''
        Architecture for an object encoder taking an input of [image_tensor (32, 40, 3), coords_tensor (4,) cxcywh]
        and returning a vector of depth 256 encoding the image
        '''
